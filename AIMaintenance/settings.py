"""
Django settings for AIMaintenance project.
...
SECRET_KEY = 'django-insecure-%xu#67jz#txwrq1gdfl_)pmoi9wu5!(96!mkh5hg*qd7q6nt+$'
...
ROOT_URLCONF = 'AIMaintenance.urls'
...
WSGI_APPLICATION = 'AIMaintenance.wsgi.application'
